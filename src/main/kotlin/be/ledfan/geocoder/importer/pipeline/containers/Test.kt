...
//    fun setup() {
////
////        val ic = be.ledfan.geocoder.importer.pipeline.IntegrationConfig("http://download.geofabrik.de/europe/belgium-190801.osm.pbf",
...
//
////        val ic = be.ledfan.geocoder.importer.pipeline.IntegrationConfig("http://download.geofabrik.de/europe/liechtenstein-latest.osm.pbf",
