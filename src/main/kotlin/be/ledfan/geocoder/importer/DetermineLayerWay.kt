...
//        }
//
//        if (parsedTags.keys.any { ignore.contains(it) }) {
//            assignLayer(layers, Layer.Superfluous)
//        }
//
//        if (parsedTags.keys.any { forcedIgnore.contains(it) }) {
//            assignLayer(layers, Layer.Superfluous)
//            return layers
//        }
//
//        if (parsedTags.hasChild("highway") && parsedTags.getSingleValueOfChild("highway") == "bus_stop") {
//            // ignore bus_stops
//            assignLayer(layers, Layer.Superfluous)
//            return layers
//        }
//
//        parsedTags.letChild("highway") { highway ->
...
//                    || (parsedTags.hasChild("access") && parsedTags.getSingleValueOfChild("access") == "no")
...
//            }
//        }
//        parsedTags.letChild("place") { place ->
...
//        }
//
//        parsedTags.letChild("addr") { addr ->
//            if (addr.hasChild("street") && addr.getSingleValueOfChild("street") == "residential") {
//                assignLayer(layers, Layer.Street)
//            }
//        }
//
...
//            }
//        }
//        parsedTags.letChild("type") {
//            if (it.hasValue("multipolygon")) {
//                assignLayer(layers, Layer.Superfluous)
//            }
//
//        }
//        parsedTags.letChild("tunnel") {
//            if (it.hasValue("culvert")) {
//                assignLayer(layers, Layer.Superfluous)
//            }
//        }
//        parsedTags.letChild("vehicle") {
//            if (it.hasValue("private")) {
//                assignLayer(layers, Layer.Superfluous)
//            }
//        }
//        parsedTags.letChild("building") {
//            assignLayer(layers, Layer.Superfluous)
//        }
//
//        parsedTags.letChild("removed") {
//            assignLayer(layers, Layer.Superfluous)
//        }
//
//        parsedTags.letChild("junction") {
//            assignLayer(layers, Layer.Junction)
//        }
//
//        parsedTags.letChild("zone") { zone ->
//            zone.letChild("traffic") {
//                assignLayer(layers, Layer.VirtualTrafficFlow)
//            }
//        }
//
//        parsedTags.letChild("maxspeed") {
//            assignLayer(layers, Layer.VirtualTrafficFlow)
//        }
//
//        if (layers.size == 0) {
